 ...
 *
 * ```js
 * const [set, args] = getSqlPatchColumns([["name", name], ["country_code", countryCode]]);
 * pool.query(`UPDATE organization SET ${set} WHERE organization_id = $4`, [...args, organizationId]);
 * ```
 *
